...
class BoundedEntryContractTest(unittest.TestCase):
    ...
    def test_bounded_entry_docs_and_ledger_are_current(self):
        ...
        self.assertIn("Phase 4 task 36", docs)
        self.assertIn("Paired Output Contract", docs)
        self.assertIn("paired_snv_vcf", docs)
        self.assertIn("normal_or_control_bedmethyl", docs)
        self.assertIn("tumour_haplotagged_alignment", docs)
        self.assertIn("old report HTML", docs)
        self.assertIn("Phase 4 task 37", docs)
        self.assertIn("normal arrives before tumour", docs)
        self.assertIn("imported normal VCF", docs)
        self.assertIn("Phase 4 task 38", docs)
        self.assertIn("tiny BAM/VCF/BED fixtures", docs)
        self.assertIn("paired_output_contracts", docs)
        self.assertIn("Phase 4 task 39", docs)
        self.assertIn("paired performance and barrier gates", docs)
        self.assertIn("relationship_snapshot_digest", docs)
