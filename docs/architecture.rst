...
CNV, STR, annotation, sex inference, and export consumers.
...
CNV, STR, and publication/export. Keep supporting operations inside those
families unless the shared controller registry is deliberately changed.
